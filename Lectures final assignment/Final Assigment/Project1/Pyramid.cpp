...
Pyramid::Pyramid(float height, float width, float length, float x, float y, float z)
{
	Height = height;
	Width = width;
	Length = length;
...
void Pyramid::InitBuffers(GLuint program_id, GLuint uniform_mvp, glm::mat4 mvp)
{
    GLuint position_id;
    GLuint color_id;

...
Hexagon::Hexagon(float height, float width, float length, float x, float y, float z)
{
	Height = height;
	Width = width;
	Length = length;
...
void Hexagon::Render(GLuint uniform_mvp, glm::mat4 projection, glm::mat4 view, glm::mat4 mvp)
{
...
void Hexagon::InitBuffers(GLuint program_id, GLuint uniform_mvp, glm::mat4 mvp)
{
    GLuint position_id;
    GLuint color_id;
